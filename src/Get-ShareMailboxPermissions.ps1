###########################################################
# Author: Exchange Administrators
# Created: UNKNOWN
#
# Updates:
#   04/28/2021 - TPS - Added documentation comments
###########################################################

<#
    .SYNOPSIS
    Gets the permissions from a Shared Mailbox.
    .DESCRIPTION
    Gets the permissions from a Shared Mailbox.
    .PARAMETER param
    ...
    example description.
    .EXAMPLE
    PS> .\script-name computername
    example description.
#>

Write-Error "This script does not currently work"
